...
sealed class NavigationItem(var route: String, var icon: Int, var title: String, var selected: Boolean = false) {
    object Noticias : NavigationItem("noticias", R.drawable.ic_article_24, "Noticias", true)
